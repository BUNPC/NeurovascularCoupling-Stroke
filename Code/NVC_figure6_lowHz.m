...
saveas(gcf,'figures/figure6_lowHz_right.png')
...
xlabel('Threshold')
set(gca, 'FontSize', 24);
saveas(gcf,'figures/figure6_lowHz_1.png')
...
set(b, 'FaceAlpha', 1)
ylim([0 0.5])
sigline1([1.69 1.85],[],0.28)
sigline2([1.69 2],[],0.3)
sigline1([1.69 2.15],[],0.32)
sigline2([1.69 2.3],[],0.34)
sigline1([2.69 2.85],[],0.35)
saveas(gcf,'figures/suppfig10a_low.png')
...
xlabel('Threshold')
set(gca, 'FontSize', 20);
saveas(gcf,'figures/figure6_lowHz_2.png')
...
set(b, 'FaceAlpha', 1)
ylim([0 1])
sigline1([0.69 0.85],[],0.41)
sigline1([1.69 1.85],[],0.61)
sigline2([1.69 2],[],0.65)
sigline1([2.69 2.85],[],0.65)
saveas(gcf,'figures/suppfig10b_low.png')
...
ylim([0 1])
set(gca, 'FontSize', 20);
saveas(gcf,'figures/figure6_lowHz_3.png')
...
set(b, 'FaceAlpha', 1)
ylim([0 1])
sigline2([0.69 0.85],[],0.5)
sigline2([1.69 2],[],0.7)
saveas(gcf,'figures/suppfig10c_low.png')
...
ylim([0 1])
set(gca, 'FontSize', 20);
saveas(gcf,'figures/figure6_lowHz_4.png')
...
set(b, 'FaceAlpha', 1)
ylim([0 1])
sigline1([0.69 0.85],[],0.55)
sigline1([1.69 1.85],[],0.65)
saveas(gcf,'figures/suppfig10d_low.png')
